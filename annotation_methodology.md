...
|---|---|---|
| 1 | A word form altered by fast/connected speech (through reduction, contraction, or phonetic assimilation, e.g. a word-initial consonant assimilating in voicing to the preceding word) and not itself an independent lexical item | The dictionary word form is restored |
